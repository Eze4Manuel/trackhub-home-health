...
class FulfilledHistory extends StatefulWidget {
  const FulfilledHistory({Key? key}) : super(key: key);

  @override
  State<FulfilledHistory> createState() => _HistoryState();
}

class _HistoryState extends State<FulfilledHistory> {
  List fulfilledDispatch = [];
